...
chcp 65001 >nul
echo ====================================================
echo  Su-35 GLB downloader (HuggingFace)
echo ====================================================
echo.
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "$u='https://huggingface.co/spaces/cutechicken/3D-Airforce-Simulator/resolve/main/models/su-35.glb';" ^
  "$o=Join-Path '%~dp0' 'su35.glb';" ^
  "$tmp=Join-Path $env:TEMP ('su35_' + [guid]::NewGuid().ToString() + '.glb');" ^
